...
cp -R "$SCRIPT_DIR/build_output/$APP_NAME.app" "$STAGING/"
...
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="{width}" height="{height}">
  ...
  <text x="300" y="60" text-anchor="middle" font-family="Helvetica Neue" font-size="16" font-weight="bold" fill="#c4581a">Plain Paste</text>
